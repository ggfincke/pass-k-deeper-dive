...
Defines constants for plot styling, annotation positioning, and axis settings.
"""

# Pass@k highlighting and axis configuration
HIGHLIGHT_KS = (1, 5, 10, 25)  # K values to annotate with coverage info
TABLE_PRECISION = 4  # Decimal places for formatted metric tables
PASS_K_XLIM = (0, 25)  # X-axis limits for pass@k plots
...
# Stacked label positioning configuration for pass@k plots
STACKED_LABEL_X_OFFSET = 12  # Horizontal offset in points
...
STACKED_LABEL_Y_PAD_FRAC = 0.075  # Vertical padding above curve as fraction of y-range
STACKED_LABEL_Y_GAP_FRAC = 0.11  # Gap between stacked labels as fraction of y-range
